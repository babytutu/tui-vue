...
export default {
  ...
  methods: {
    ...
    drawArrow(ctx) {
      ...
      // 画内圆
      ctx.arc(
        this.headCenter.x, this.headCenter.y,
        arrowRadius - (this.arrowWidth - rate), -Math.PI / 2, 0, true,
      )
      ...
      ctx.lineTo((this.headCenter.x + (this.arrowWidth * 2)) -
        (rate * 2), (this.headCenter.y - arrowRadius) + (this.arrowWidth / 2))
